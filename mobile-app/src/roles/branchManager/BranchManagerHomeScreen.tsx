            ...
            return (
              <View 
                ...
                style={{ 
                  ...
                  padding: spacing.lg,
                  borderLeftWidth: 3,
                  borderLeftColor: incident.status === "Escalated" ? colors.error : colors.brand
                }}
              >
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={{ fontSize: fontSize.xs, color: colors.slate500, marginTop: 2 }}>
                      {branch?.name || "Territory"} · {incident.type} · {incident.createdAt ? String(incident.createdAt).slice(0, 10) : "—"}
                    </Text>
