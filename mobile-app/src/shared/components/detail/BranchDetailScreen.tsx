      ...
      <View style={{ gap: spacing.xl }}>
        <Card variant="glass">
          <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: fontSize.lg, fontWeight: "600", color: colors.text }}>Staff Overview</Text>
        ...
        <Card variant="glass">
          <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: fontSize.lg, fontWeight: "600", color: colors.text }}>Budget & Finance</Text>
          </View>
        ...
        <Card variant="glass">
          <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: fontSize.lg, fontWeight: "600", color: colors.text }}>Alerts & Issues</Text>
        ...
        <Card variant="glass">
          <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: fontSize.lg, fontWeight: "600", color: colors.text }}>Appliance Status</Text>
        ...
        <Card variant="glass">
          <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: fontSize.lg, fontWeight: "600", color: colors.text }}>Task Summary</Text>
          </View>
          <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.md }}>
        ...
        <Card variant="glass">
          <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: fontSize.lg, fontWeight: "600", color: colors.text }}>Branch Info</Text>
          </View>
          <View style={{ gap: spacing.md }}>
            {[
